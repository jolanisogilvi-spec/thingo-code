...
describe("App root agent-server availability guard", () => {
  ...
  it.skip("legacy locked-Cloud first-run mode is disabled in Thingo Code", async () => {
  ...
  it.skip("legacy locked-Cloud baked-key behavior is disabled in Thingo Code", async () => {
  ...
  it.skip("legacy locked-Cloud stale-local behavior is disabled in Thingo Code", async () => {
  ...
  it.skip("legacy locked-Cloud configured-LLM behavior is disabled in Thingo Code", async () => {
  ...
  it.skip("legacy locked-Cloud host replacement is disabled in Thingo Code", async () => {
  ...
  it.skip("legacy locked-Cloud completion override is disabled in Thingo Code", async () => {
  ...
  it("shows recovery without a Cloud login action for a logged-out legacy backend", async () => {
    const cloudBackend = {
      id: "cloud-expired",
    ...
    expect(
      screen.queryByRole("button", { name: "Log back in" }),
    ).not.toBeInTheDocument();
    expect(screen.queryByTestId("app-outlet")).not.toBeInTheDocument();
  });

  it.skip("legacy locked-Cloud recovery is disabled in Thingo Code", async () => {
    vi.stubEnv("VITE_LOCK_TO_CLOUD", "https://app.all-hands.dev");
    const cloudBackend = {
      id: "cloud-expired",
      name: "OpenHands Cloud",
  ...
  it.skip("legacy Cloud-lock root routing is retired", async () => {
    vi.stubEnv("VITE_LOCK_TO_CLOUD", "https://app.all-hands.dev");
    vi.stubEnv("VITE_SESSION_API_KEY", "");
    delete (window as unknown as Record<string, unknown>)
      .__AGENT_CANVAS_SESSION_API_KEY__;
  ...
  it.skip("legacy locked-cookie auth routing is disabled in Thingo Code", async () => {
    const assign = vi.fn();
    Object.defineProperty(window, "location", {
      configurable: true,
      value: {
  ...
  it.skip("legacy locked-cookie session routing is disabled in Thingo Code", async () => {
  ...
  it.skip("legacy locked-cookie health routing is disabled in Thingo Code", async () => {
  ...
  it.skip("legacy locked-Cloud login completion is disabled in Thingo Code", async () => {
