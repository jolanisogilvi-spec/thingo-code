...
export function ChatInputActions({
  ...
  const showAgentProfileSwitch = false;
  // Thingo Code exposes a single agent identity on every backend.
  const showChangeAgentButton = false;
    ...
    >
      <div className="flex min-w-0 items-center gap-1">
        <div className="flex min-w-0 items-center gap-3">
          ...
          {showChangeAgentButton && <div ref={codeRef} />}
