...
/**
 * Pre-fills the LLM form with Thingo's DeepSeek V4 Flash preset. The explicit
 * overrides mark the model and OpenAI-compatible endpoint dirty so the Next
 * button persists both values together.
 */
export const ONBOARDING_DEFAULT_LLM_MODEL = THINGO_DEFAULT_LLM_MODEL;
export const ONBOARDING_DEFAULT_LLM_BASE_URL = THINGO_LLM_BASE_URL;
export const ONBOARDING_THINGO_LLM_INITIAL_VALUES = {
  ...THINGO_LLM_DEFAULT_VALUES,
};
 ...
 * who need the Thingo default pre-filled.
 */
    ...
    >
      ...
      >
        <LlmSettingsScreen
          ...
          initialValueOverrides={ONBOARDING_THINGO_LLM_INITIAL_VALUES}
