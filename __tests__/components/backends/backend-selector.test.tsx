...
describe("BackendSelector", () => {
  ...
  it("lists local backends and hides saved Cloud backends", async () => {
    renderWithProviders(
      <TestSeed
        onMount={(ctx) => {
  ...
  it.skip("legacy Cloud organization switching is hidden in Thingo Code", async () => {
    vi.mocked(getCloudOrganizations).mockResolvedValue({
      items: [
  ...
  it.skip("legacy Cloud API-key organization rows are hidden in Thingo Code", async () => {
  ...
  it.skip("legacy cookie-auth Cloud rows are hidden in Thingo Code", async () => {
    vi.mocked(getCloudOrganizations).mockResolvedValue({
      items: [
        { id: "org-personal", name: "Personal" },
        { id: "org-acme", name: "Acme Inc" },
  ...
  it.skip("legacy Cloud personal-workspace rows are hidden in Thingo Code", async () => {
  ...
  it.skip("legacy Cloud selection healing is hidden in Thingo Code", async () => {
    const personalOrgId = "0b93b5f2-5396-49f2-8d98-61f906184270";
    vi.mocked(getCloudOrganizations).mockResolvedValue({
      items: [
  ...
  it("ignores a legacy Cloud lock and keeps local backend actions", async () => {
  ...
  it.skip("legacy locked cookie-auth Cloud UI is hidden in Thingo Code", async () => {
