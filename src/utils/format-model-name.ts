...
export const FREE_OPENHANDS_MODELS = {
  "openhands/deepseek-v4-flash": "Thingo Code DeepSeek V4 Flash (free)",
} as const;
...
export const FREE_OPENHANDS_MODEL_NOTE = `Free Thingo Code models: ${FREE_OPENHANDS_MODEL_IDS.join(
  ", ",
