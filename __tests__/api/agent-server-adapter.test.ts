...
describe("buildStartConversationRequest", () => {
  ...
  describe.skip("legacy ACP secret delivery (not used by Thingo Code launches)", () => {
  ...
  describe("client tool injection", () => {
    ...
    it("normalizes an inline ACP setting to Thingo Code client tools", () => {
      const payload = buildStartConversationRequest({
        settings: {
          ...DEFAULT_SETTINGS,
          agent_settings: {
    ...
    it("ignores an ACP profile and keeps Thingo Code client tools", () => {
      const payload = buildStartConversationRequest({
        settings: DEFAULT_SETTINGS,
...
describe.skip("legacy ACP start-request construction (disabled in Thingo Code)", () => {
