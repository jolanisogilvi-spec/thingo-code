#!/usr/bin/env node
/**
 * Thingo Code compatibility CLI entry point for @openhands/agent-canvas
 *
 * Runs the full Thingo Code stack locally by default:
...
if (args.includes("-h") || args.includes("--help")) {
  console.log(`
@openhands/agent-canvas - Run Thingo Code with a local agent-server
