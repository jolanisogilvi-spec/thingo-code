...
describe("OnboardingModal", () => {
  ...
  it("starts first-run no-backend onboarding as Add a backend without an error banner", () => {
    ...
    expect(screen.queryByTestId("onboarding-backend-cloud-title")).toBeNull();
    expect(screen.queryByTestId("onboarding-backend-login-button")).toBeNull();
    expect(screen.getByTestId("onboarding-backend-host")).toBeVisible();
  });

  it.skip("legacy locked-Cloud onboarding is disabled in Thingo Code", () => {
    window.localStorage.clear();
    vi.stubEnv("VITE_BACKEND_BASE_URL", "");
    vi.stubEnv("VITE_SESSION_API_KEY", "");
  ...
  it.skip("legacy locked-Cloud replacement is disabled in Thingo Code", async () => {
  ...
  it.skip("legacy locked-Cloud host matching is disabled in Thingo Code", async () => {
  ...
  it.skip("legacy Cloud organization replacement is disabled in Thingo Code", async () => {
  ...
  it.skip("legacy locked-Cloud backend skipping is disabled in Thingo Code", async () => {
  ...
  it.skip("legacy Cloud login onboarding is disabled in Thingo Code", async () => {
  ...
  it.skip("legacy Gemini ACP onboarding is disabled in Thingo Code", async () => {
    renderModal();
    const user = userEvent.setup();
  ...
  it.skip("legacy Claude ACP onboarding is disabled in Thingo Code", async () => {
    renderModal();
    const user = userEvent.setup();
  ...
  it.skip("legacy ACP credential onboarding is disabled in Thingo Code", async () => {
    renderModal();
    const user = userEvent.setup();
