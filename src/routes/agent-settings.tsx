...
export function AgentSettingsScreen({
  ...
  useEffect(() => {
    ...
    if (kind === "acp" && embedded && agentSettingsOverride != null) {
      setAgentType("acp");
  ...
  }, [settings, embedded, agentSettingsOverride]);
...
/**
 * Canonical Thingo Code Agent settings route. It renders the native-agent form
 * directly; named Agent Profiles remain backend compatibility data and are not
 * exposed as a separate product surface.
 */
