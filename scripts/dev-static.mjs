...
function showHelp() {
  console.log(`
Thingo Code Static-frontend Development Stack
...
function printBanner(config) {
  ...
  console.log(
    `${c.green}${c.bold}║${c.reset}  ${c.bold}Thingo Code Static-frontend Stack${c.reset}                          ${c.green}${c.bold}║${c.reset}`,
  );
  console.log(
    `${c.green}${c.bold}╠══════════════════════════════════════════════════════════════╣${c.reset}`,
  );
...
async function main() {
  ...
  console.log("");
  console.log(
    `${c.cyan}${c.bold}Thingo Code Static-frontend Development Stack${c.reset}`,
  );
  console.log("");
