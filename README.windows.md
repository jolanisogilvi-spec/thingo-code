# Thingo Code on Windows (PowerShell)

Thingo Code is developed by **Thingo**. This document contains Windows-specific
PowerShell syntax for running the compatible Docker sandbox workflow.

For the desktop installer, first LLM setup, and everyday usage, see
[README.md](./README.md) and [快速开始](./docs/GETTING_STARTED.md).
